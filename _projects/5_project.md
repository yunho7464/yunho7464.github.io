...
Ensemble perception is the ability of the visual system to quickly extract aggregate statistical information (e.g., average) from groups of similar objects. Audiovisual integration examines how concurrent auditory stimuli influence vision and vice versa. In this study, we explored whether sounds of varying pitches could impact the perceived average in visual ensemble perception.
