...
<div class="row">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.html path="assets/img/pitch_perfect_indipowerlaw.jpg" title="figure1" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.html path="assets/img/pitch_perfect_normalized.jpg" title="figure2" class="img-fluid rounded z-depth-1" %}
    </div>
...
2. Models fitted with normalized data had fewer errors. However, data standardization is not necessary when minimum and maximum mapping are assigned. The result suggests that it is hard for participants to learn the mapping used in a system.